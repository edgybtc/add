...
<link href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css" rel="stylesheet">
  ...
  <li class="nav-item">
                <a class="nav-link active" href="referral.php">
                  <span data-feather="file"></span>
                  Referral Details
                </a>
              </li>
            ...
            <table id="example" class="display">
              ...
              <thead>
                <tr>
                  ...
                  <th>Refcode</th>
                  <th>Referred By</th>
<th>Level 1 Total,Active</th>
<th>Level 2 Total,Active</th>
                 <th>Level 3 Total,Active</th>
  <th>Level 4 Total,Active</th>
  <th>BTC Commission</th>
  <th>LTC Commission</th>
<th>ETH Commission</th>
<th>BCASH Commission</th>
...
$sql2 = 'SELECT *
                FROM referral WHERE chat_id='.$chat_id;
...
$btc_active=floatval($row['btc_commision'])/100000000;

$ltc_active=floatval($row['ltc_commision'])/100000000;

$bcash_active=floatval($row['bcash_commision'])/100000000;

$eth_active=floatval($row['eth_commision'])/100000000;
 ...
 <td>'.$row2['ref_1'].'</td>
 <td>'.$row2['ref_1_t'].','.$row2['ref_1_a'].'</td>
 <td>'.$row2['ref_2_t'].','.$row2['ref_2_a'].'</td>
 <td>'.$row2['ref_3_t'].','.$row2['ref_3_a'].'</td>
		<td>'.$row2['ref_4_t'].','.$row2['ref_4_a'].'</td>
