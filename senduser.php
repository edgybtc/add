...
<li class="nav-item">
                <a class="nav-link active" href="senduser.php">
                  <span data-feather="file"></span>
                  Direct Message
                </a>
              </li>
...
$(document).ready(function() {
    $('#example').DataTable();
        ...
        <?php
		 if (isset($_POST["uid"]) && !empty($_POST["uid"]) && isset($_POST["text"]) && !empty($_POST["text"])  ){
			$chat_id=intval($_POST["uid"]);
//$conn->query("UPDATE plan_detail SET rate=$rate WHERE plan=\"default\"");
$text=urlencode($_POST["text"]);
$url='https://api.telegram.org/bot600164611:AAHk3UVLNjFXuKtSTIm004kYwXjYXF5eWDM/';
