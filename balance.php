...
$btc_active=floatval($row['btc_active'])/100000000;

$ltc_active=floatval($row['ltc_active'])/100000000;

$bcash_active=floatval($row['bcash_active'])/100000000;

$eth_active=floatval($row['eth_active'])/100000000;
$btc_invest=floatval($row['btc_invest'])/100000000;
$ltc_invest=floatval($row['ltc_invest'])/100000000;
$eth_invest=floatval($row['eth_invest'])/100000000;
$bcash_invest=floatval($row['bcash_invest'])/100000000;
